/**********************************************************
 *   diffspecbinorm.frag:  A shader to render the colors
...
/** \class diffspecbinorm.frag A shader to render the colors
 *   for an OpenGL program.  It passes along reflection 
 *   data, and it was found on www.learnopengl.com.
 */
...
vec3 CalcDirLight(vec3 light, vec3 viewDir)
{
    lightDir = normalize(vec3( -50.0f,  150.0f,  50.0f) - locval.Position);
    // Diffuse shading
